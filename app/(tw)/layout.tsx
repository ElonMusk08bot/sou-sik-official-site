...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Sou Sik｜Mechanical Coffee Instruments', description: '精密機械 × 精品咖啡。探索 Sou Sik P-1 行星齒輪手搖磨豆機。', url: 'https://sousikgrinder.com', siteName: 'Sou Sik', locale: 'zh_TW', type: 'website' },
